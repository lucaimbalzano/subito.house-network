...
# MESSAGES templates
#RENT
MSG_INTRO_RENT_01 = 'Buongiorno, sono 𝘚𝘪𝘮𝘰𝘯𝘦 𝘐𝘮𝘣𝘢𝘭𝘻𝘢𝘯𝘰 ed sono interessato al tuo immobile in affitto: '

MSG_PROPOSAL_RENT_01 = 'Ti scrivo per proporti una consulenza 𝘴𝘵𝘳𝘢𝘵𝘦𝘨𝘪𝘤𝘢 𝗴𝗿𝗮𝘁𝘂𝗶𝘁𝗮 specifica per il tuo appartamento che durerà circa 20/30min. %0AAlla fine del nostro incontro ti lascerò il nostro 𝗣𝗜𝗔𝗡𝗢 di 𝗥𝗘𝗡𝗗𝗜𝗠𝗘𝗡𝗧𝗢, proprio come questo ⬇️⬇️'

MSG_TIME_APPOINTMENT_RENT_01 = 'preferisci incontrarci domani alle 18pm o alle 20pm?'
...
MSG_PROPOSAL_SALE_01 = 'Ti scrivo per proporti una consulenza 𝘴𝘵𝘳𝘢𝘵𝘦𝘨𝘪𝘤𝘢 𝗴𝗿𝗮𝘁𝘂𝗶𝘁𝗮 specifica per il tuo appartamento che durerà circa 20/30min. %0AAlla fine del nostro incontro ti lascerò il nostro 𝗣𝗜𝗔𝗡𝗢 di 𝗥𝗘𝗡𝗗𝗜𝗠𝗘𝗡𝗧𝗢, proprio come questo ⬇️⬇️'
MSG_TIME_APPOINTMENT_SALE_01 = 'preferisci incontrarci domani alle 18pm o alle 20pm?'
MSG_TIME_APPOINTMENT_SALE_02 = 'scrivimi "𝗕𝗡𝗕" se vuoi anche tu il piano di rendimento!'





MSG_INTRO_SALE_02_A_00 = 'sono Simone Imbalzano ho 25 anni ed ho aperto la mia agenzia immobiliare.'
MSG_COPY_SALE_02_A01 = "So che non ce la fai più a sentire agenti che al telefono ti dicono:"
...
MSG_COPY_SALE_03_A06 = "- sapere se hai tutti i documenti in regola"
MSG_COPY_SALE_03_A07 = "- Documenti Necessari per Vendere Casa"
MSG_COPY_SALE_03_A08 = "Io dico sempre: 'se un Agente Immobiliare serve a mettere un cartello ed un annuncio fatelo da soli.'  Visto che ha già ascoltato il mio consiglio... BE DIFFERENT"
MSG_COPY_SALE_03_A09 = "Se desideri una consulenza strategica specifica per il tuo appartamento, sono a disposizione per una chiacchierata di 15 minuti, senza vincoli."
MSG_COPY_SALE_03_A10 = "A presto"
